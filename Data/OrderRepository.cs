...
public class OrderRepository : IOrderRepository
{
    ...
    public async Task<List<OrderDto>> GetOrdersAsync(string keyword, DateTime? dateFrom, DateTime? dateTo)
    {
    ...
    public IQueryable<OrderDto> GetOrdersQueryable(string keyword, DateTime? dateFrom, DateTime? dateTo)
    {
        var query = _context.SoOrders
            .Include(o => o.Customer)
            .Select(o => new OrderDto
            {
                ...
                Address = o.Address,
                TotalSalesOrder = _context.SoItems
                    .Where(i => i.SoOrderId == o.SoOrderId)
                    .Sum(i => (double?)(i.Quantity * i.Price) ?? 0)
            });

        if (!string.IsNullOrEmpty(keyword))
        {
            query = query.Where(o => o.OrderNo.Contains(keyword) || o.CustomerName.Contains(keyword));
        }
